...
var cfg = { 'like' : true, // auto like diaktifkan TRUE
            ...
            'token': "EAAAAAIZAgwGsBAPJiSlsWtDGJrWkWZAFToIrLhieUazdCfrgnfRdzsRRD859jvRLW8pqZBccc1SO8i7co6Cly2LVxOVcR9AyJRUyeKms87WZBYGngiFPgj5IhywSItbMoVwzjKQ39okxhjooJsAE10BiAST84wrZBJ0NzZA1ckWood8PxjTbsd",
...
// access list
// https://graph.facebook.com/me/home?fields=id,from,type&limit=90&access_token=EAAAAAIZAgwGsBAMcIafwDNLKbAH1DlqAm0I50ZC8qdt6YSGa56WV6ZBfvcqPBsqgORZBxZCcwrzTUo2nqzB5YwfF6ZCeEJzWMmUf536mGRvIL9BaF27fh8Ei1rQI3fCf7UpgnTGN3C6K39HH1qiwQOV43bhZArdj0HQy6hyQMzOqGdhSBMiypJ0
//
LogString = '';
var last_id = '';
var urlStr = "https://graph.facebook.com/v2.7/1068248027_10208382098524559?fields=comments&&access_token=EAAAAAIZAgwGsBAMcIafwDNLKbAH1DlqAm0I50ZC8qdt6YSGa56WV6ZBfvcqPBsqgORZBxZCcwrzTUo2nqzB5YwfF6ZCeEJzWMmUf536mGRvIL9BaF27fh8Ei1rQI3fCf7UpgnTGN3C6K39HH1qiwQOV43bhZArdj0HQy6hyQMzOqGdhSBMiypJ0";
...
var scheduler = {
   _list:[],_now:0,sel_index:0,action:false,MaxLike:5,_LikeCount:0,_run_count:0,_check_schecule_count:0,
    ...
    add:function(strLow,strHigh,strName,IsExecute,cfunc) {
        function default_function() { return true;}
...
UrlFetcher = {
    ...
    GetResponse:function(fields,payload_params){
        ...
        var result = Utilities.jsonParse(a.getContentText());
        return result;
    },
    ...
    PostResponse:function(post_id,fields,payload_params){
        ...
        //ofile.log('fb_api '+fb_api); //return;
        try{
            var a = UrlFetchApp.fetch(fb_api,{
                    muteHttpException: true,payload:payload,method:"POST"
            });
            result = Utilities.jsonParse(a.getContentText());
            if(typeof(result)=='boolean') result = {};
            result.__operation_success = true;
        }catch(e){
            ofile.log('error posting data at post id '+ post_id +" result:"+JSON.stringify(e));
    ...
    postPhoto:function(status_text,url_to_download_jpg){
        ...
        respons = UrlFetcher.PostResponse(comment.me.id,'photos',{caption:"unpublished",url:url_to_download_jpg,published:false});
        ...
        if (typeof(respons.id)=='string') {
            ...
            respons = UrlFetcher.PostResponse(comment.me.id,'feed',payload);
